...
/** Registers the "Auction Flip Finder" (`/saibonah`) settings section. Called once from `SaibonClient.onInitializeClient()`. */
    ...
    fun register() {
        SettingsRegistry.register(
            SettingsSection(SaibonCategory.DATA, "Auction Flip Finder") {
                ...
                toggle("Track recent sales (powers /saibonah)", config.salesHistoryAutoRefresh) {
